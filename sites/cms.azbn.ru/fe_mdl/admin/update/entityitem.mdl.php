...
$id=$this->FE->c_s($param['req_arr']['param_3']);
...
if($_SESSION['user']['right']['change_entityitem_superuser'] && isset($_POST['user'])) {
	$param['new_el']['user']=$this->FE->as_int($_POST['user']);
	}

$this->FE->DB->dbUpdateArr($table,$param['new_el'],"WHERE id='$id'");
