...
<div class="row" >
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
		...
		<small ><a href="<?=$this->FE->CMS->genLink($param['cat_id'],'pagecat',true,true);?>" ><?=$param['cat_id']['title'];?></a></small>
		<div class="clear10" ></div>
		<h2 data-liveedit="page:<?=$param['item_id']['id'];?>:title" ><?=$param['item_id']['title'];?></h2>
	...
	<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" >
		...
		<div class="" data-liveedit="page:<?=$param['item_id']['id'];?>:preview" ><?=$param['item_id']['preview'];?></div>
		
		<hr />
		
		<div class="" data-liveedit="page:<?=$param['item_id']['id'];?>:main_info" ><?=$param['item_id']['main_info'];?></div>
