...
function showEntityWithChildren(&$catalog,$entity_id,$entity_type='newscat') {
	?>
	<div class="row" >
...
<div class="page-header" >
	<h3>
		...
		<a href="/admin/add/newscat/" title="Создать категорию" ><img class="icon" src="/img/cms.azbn.ru/add.png" /></a>
	</h3>
</div>
	...
	if(count($catalog['structure'][0])) {
		foreach($catalog['structure'][0] as $index=>$entity) {
			showEntityWithChildren($catalog,$index,'newscat');
			}
		}
	?>