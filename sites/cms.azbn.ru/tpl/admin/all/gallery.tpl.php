...
function showEntityWithChildren(&$catalog,$entity_id,$entity_type='gallery') {
	?>
	<div class="row" >
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
			...
			<div class="pull-right" >
				<small>
					...
					<a href="/admin/add/<?=$entity_type;?>item/?gal=<?=$entity_id;?>" title="Добавить изображение" ><img class="icon" src="/img/cms.azbn.ru/add.png" /></a>
					...
					<a href="/admin/add/<?=$entity_type;?>/?parent=<?=$entity_id;?>" title="Создать подгалерею" ><img class="icon" src="/img/cms.azbn.ru/add_child.png" /></a>
...
<div class="page-header" >
	<h3>
		Список галерей
		<a href="/admin/add/gallery/" title="Создать галерею" ><img class="icon" src="/img/cms.azbn.ru/add.png" /></a>
	</h3>
</div>
	...
	if(count($catalog['structure'][0])) {
		foreach($catalog['structure'][0] as $index=>$entity) {
			showEntityWithChildren($catalog,$index,'gallery');
			}
		}
	?>